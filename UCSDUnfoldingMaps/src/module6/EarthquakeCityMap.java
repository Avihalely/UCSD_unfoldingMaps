...
//		 
	...
	//(hint: there is a method in the List interface named toArray() 
	//which returns the elements in the List as an array of Objects)
	//Then it will sort the array of earthquake markers in reverse order of their magnitude 
	...
	//but it should not crash.Call this method from setUp() to test it.
