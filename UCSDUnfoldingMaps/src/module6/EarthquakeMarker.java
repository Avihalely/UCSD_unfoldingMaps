...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable <EarthquakeMarker> 
{
	...
	// TODO: Add the method: 
/*the compareTo compares the calling object Earthquake Marker,
	to the parameter EarthquakeMarker. And returns either a negative value,
	zero, or a positive value depending on the relationship between those two objects
*/	
...
System.out.println("*****************try to comapre");
	// אמור לבצע השוואה של חוזק רעידת האדמה- אבל לא ברור אם בכלל מבוצע
